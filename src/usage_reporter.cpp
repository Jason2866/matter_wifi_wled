/*
 * Matter WiFi WLED Bridge - Usage Reporter Implementation
 *
...
// ---- Build-time constants ----
  ...
  #define FIRMWARE_RELEASE_NAME "MatterWiFiWLED"
#endif
