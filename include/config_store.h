/*
 * Matter WiFi WLED Bridge - Configuration Storage
 *
...
struct LightState {
  ...
  float    colorX;       // CIE 1931 x (0.0-1.0), last received from Matter
  float    colorY;       // CIE 1931 y (0.0-1.0), last received from Matter
